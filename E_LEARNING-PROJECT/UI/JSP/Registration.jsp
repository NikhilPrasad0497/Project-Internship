...
<h1 style="background-color:threedlightshadow;font-size: x-large;font-family: cursive;">REGISTRATION FORM</h1>
  ...
  <label>
    ...
    <input type="password" class="input" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" name="pwd"  id="pwd" onchange="CheckPassword(document.form1.pwd)" required></br>
  ...
  <div class="column" >
    ...
    <input type="number" name="age" min="18" patternrequired>
  ...
  <label>
    ...
    <input type="text" class="input" name="no" required width="20%" pattern=".{10}" onchange="CheckNumber(document.form1.no)"">
    <div class="line-box1">
      <div class="line"></div>
    </div>
  </label>
 ...
 <div class="column" >
  ...
  <div class="column" >
   <label>
    ...
    <input type="text" class="input" pattern=".{6}" required>
    <div class="line-box2">
      <div class="line"></div>
    </div>
  </label>
